...
import { UserData, AdditionalInfos } from "../../utils/firebase.utils";

export type SignInSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_IN_SUCCESS, UserData>;
export type CheckUserSession = Action<USER_ACTION_TYPES.CHECK_USER_SESSION>;
export type GoogleSignInStart = Action<USER_ACTION_TYPES.GOOGLE_SIGN_IN_START>;
export type GoogleRedirectSignInStart = Action<USER_ACTION_TYPES.GOOGLE_REDIRECT_SIGN_IN_START>;
...
export type SignUpSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user: UserData, additionalDetails: AdditionalInfos} >;
...
export const googleRedirectSignInStart = withMatcher((): GoogleRedirectSignInStart => createAction(USER_ACTION_TYPES.GOOGLE_REDIRECT_SIGN_IN_START));
...
export const signUpSuccess = withMatcher((user: UserData, additionalDetails: AdditionalInfos): SignUpSuccess => createAction(USER_ACTION_TYPES.SIGN_UP_SUCCESS, {user, additionalDetails}));
